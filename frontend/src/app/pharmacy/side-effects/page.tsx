    ...
    <div className="max-w-5xl">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-[12px] font-bold whitespace-nowrap transition-all duration-200 ${
              activeStatus === s.key
                ...
                : 'bg-white dark:bg-zinc-900 text-slate-600 dark:text-zinc-400 border border-slate-200 dark:border-zinc-700 hover:border-sky-300'
            }`}
          >
            {s.label}
          </button>
      ...
      <div className="space-y-3">
        {loading ? (
          ...
          <div className="glass rounded-3xl card-shadow p-12 text-center">
          ...
          reports.map((r) => {
            ...
            return (
              <Link
                ...
                className="glass rounded-3xl card-shadow p-5 flex items-start gap-4 hover:shadow-xl active:scale-[0.99] transition-all duration-200 group"
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className="text-[14px] font-bold text-slate-800 dark:text-zinc-100 truncate group-hover:text-sky-700 dark:group-hover:text-sky-400 transition-colors">
                      {r.medicineName}
                    </h3>
                    <span
