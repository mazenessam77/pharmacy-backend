          ...
          reports.map((r) => {
            ...
            return (
              <Link
                ...
                className="bg-white rounded-none border border-neutral-200 p-5 flex items-start gap-4 hover: active:scale-[0.99] transition-all duration-200 group"
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className="text-[14px] font-bold text-neutral-800 truncate">
                      {r.medicineName}
                    </h3>
                    <span
